...
return [
    ...
    'description' => 'RESTful API for managing loans, borrowers, payments, EMI schedules, and reports. Supports multi-tenancy, role-based access control, partial payments, foreclosure, audit logging, and in-app notifications.',
    ...
    'auth' => [
        ...
        'extra_info' => 'This API uses Laravel Sanctum for authentication. Obtain a token by sending a POST request to `/api/login` with valid credentials. Include the token in the `Authorization` header as `Bearer {token}`.',
    ],
